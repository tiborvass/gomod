...
import (
	...
	"github.com/tiborvass/gomod/internal/cache"
...
func (b *Builder) fmtcmd(dir string, format string, args ...interface{}) string {
	...
	if dir != "" && dir != "/" {
		...
		cmd = mystrings.ReplaceAll(" "+cmd, " "+dir, dot)[1:]
		if b.scriptDir != dir {
			b.scriptDir = dir
			cmd = "cd " + dir + "\n" + cmd
		}
	...
	if b.WorkDir != "" {
		cmd = mystrings.ReplaceAll(cmd, b.WorkDir, "$WORK")
	}
	return cmd
}
...
func (b *Builder) showOutput(a *Action, dir, desc, out string) {
	...
	if reldir := base.ShortPath(dir); reldir != dir {
		suffix = mystrings.ReplaceAll(suffix, " "+dir, " "+reldir)
		suffix = mystrings.ReplaceAll(suffix, "\n"+dir, "\n"+reldir)
	}
	suffix = mystrings.ReplaceAll(suffix, " "+b.WorkDir, " $WORK")
